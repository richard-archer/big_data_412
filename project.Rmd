...
expl1 <- 
  ...
  mutate(D = if_else(is.na(D)== TRUE, 0, D),
        ...
        cf = D + I + R)
sort.expl1 <- expl1[order("cf")] #why won't this work
sort.expl1 <- sort(expl1$cf) #where are the states??
#once you sort, you can order states by who had the most campaign spending
